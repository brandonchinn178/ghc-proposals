...
Update `Section 10.2 <https://www.haskell.org/onlinereport/haskell2010/haskellch10.html#x17-17700010.2>`_ to add ``modid . string`` to ``literal``:

.. code-block:: abnf

  literal → integer | float | char | string | modid . string
